...
public class PropertyAnimationView extends View {
    ...
    private static final int COLOR_ADJUSTER = 4;
    ...
    public void setRadius(float radius){
        ...
        // Updating the property does not automatically redraw. SO force redraw
        invalidate();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        repeatAnimator.setInterpolator(new AccelerateInterpolator());
        repeatAnimator.setRepeatCount(1);
        repeatAnimator.setRepeatMode(ValueAnimator.REVERSE);
        //Add listener to animator to perform any action at specific animation status
